...
class MonthSelector extends StatefulWidget {
  ...
  const MonthSelector({
    Key key,
    DateTime this.openDate,
    DateTime this.selectedDate,
    this.onMonthSelected,
    this.upDownPageLimitPublishSubject,
    this.upDownButtonEnableStatePublishSubject,
    this.firstDate,
    this.lastDate,
    this.locale,
...
class MonthSelectorState extends State<MonthSelector> {
  ...
  Widget _getMonthButton(final DateTime date, final String locale) {
    ...
    return TextButton(
      ...
      //             ? AppColors.blue
      //             : AppColors.white),
      //      textStyle: MaterialStateProperty.all(TextStyles.defaultRegular)
      //
      ...
      //     //         : TextStyle.lerp(TextStyle(), TextStyle(), 1.0))
      //     ),
      child: Text(
